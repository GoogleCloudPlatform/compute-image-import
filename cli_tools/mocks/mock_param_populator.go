...
func (m *MockPopulator) PopulateMissingParameters(project *string, clientID string, zone, region, scratchBucketGcsPath *string, file string, storageLocation, network, subnet *string, workerMachineSeries *[]string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PopulateMissingParameters", project, clientID, zone, region, scratchBucketGcsPath, file, storageLocation, network, subnet, workerMachineSeries)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockPopulatorMockRecorder) PopulateMissingParameters(project, clientID, zone, region, scratchBucketGcsPath, file, storageLocation, network, subnet, workerMachineSeries interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PopulateMissingParameters", reflect.TypeOf((*MockPopulator)(nil).PopulateMissingParameters), project, clientID, zone, region, scratchBucketGcsPath, file, storageLocation, network, subnet, workerMachineSeries)
}
