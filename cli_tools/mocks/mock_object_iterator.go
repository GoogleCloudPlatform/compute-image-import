...
// Source: github.com/GoogleCloudPlatform/compute-image-import/cli_tools/common/domain (interfaces: ObjectIteratorInterface)
...
func (mr *MockObjectIteratorInterfaceMockRecorder) Next() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Next", reflect.TypeOf((*MockObjectIteratorInterface)(nil).Next))
}
