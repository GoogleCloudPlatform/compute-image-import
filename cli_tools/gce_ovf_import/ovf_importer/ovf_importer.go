...
import (
	...
	"github.com/GoogleCloudPlatform/compute-image-import/cli_tools/common/deleter"
	...
	ovfgceutils "github.com/GoogleCloudPlatform/compute-image-import/cli_tools/gce_ovf_import/gce_utils"
	multidiskimporter "github.com/GoogleCloudPlatform/compute-image-import/cli_tools/gce_ovf_import/multi_disk_importer"
...
func (oi *OVFImporter) importBootDiskImage(bootDiskInfos ovfutils.DiskInfo, disksNamesPrefix string) error {
	...
	imageName, err := daisyutils.GenerateValidDisksImagesName("boot-image-", disksNamesPrefix)
	if err != nil {
		return daisy.Errf("Failed to create disk by api inflater: %v", err)
	}
