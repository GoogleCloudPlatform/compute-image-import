...
require (
	...
	github.com/GoogleCloudPlatform/compute-daisy v0.0.0-20231114191308-36d2ee64eace // indirect
	github.com/GoogleCloudPlatform/compute-image-import/proto/go v0.0.0-00010101000000-000000000000 // indirect
